...
class ProfitMain extends Component  {
  ...
  render(){
    const{Id}=this.props
    return (
      <div className="conteinerRM">
        <div className="conteinerC" style={{width:"100%"}}>
        ...
        <div className="conteinerC" style={{paddingTop:"35px"}}>
            ...
            <div className="ProfitStats">
                <div className="ProfitStatsConteiner">
                  <div className="ProfitStatsConteinerF1M">
                    {this.props.State.DefaultOperation.ListOfUser[Id].stats.new_orders.n}
                  </div>
                  <div className="ProfitStatsConteinerF2M" style={{color:"rgb(70, 149, 217)"}}>
                    NEW ORDER
                  </div>
                  <div className="ProfitStatsConteinerF3M">
                ...
                <div className="ProfitStatsConteiner">
                  ...
                  <div className="ProfitStatsConteinerF2M" style={{color:"rgb(33, 187, 57)"}}>
                    TOTAL SALES
                  </div>
                  <div className="ProfitStatsConteinerF3M">
                ...
                <div className="ProfitStatsConteiner">
                  ...
                  <div className="ProfitStatsConteinerF2M" style={{color:"rgb(242, 168, 10)"}}>
                    TOTAL PAID OUT
                  </div>
                  <div className="ProfitStatsConteinerF3M">
                ...
                <div className="ProfitStatsConteiner">
                  ...
                  <div className="ProfitStatsConteinerF2M" style={{color:"rgb(252, 86, 94)"}}>
                    NEW CUSTOMERS
                  </div>
                  <div className="ProfitStatsConteinerF3M">
