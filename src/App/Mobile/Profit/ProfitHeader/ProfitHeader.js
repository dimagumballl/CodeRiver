...
class ProfitHeader extends Component {
  render(){
    const{Id}=this.props
    return (
      <div className="PHconteinerRM">
          
          <div style={{fontSize:"24pt",color:"rgb(53, 64, 82)", marginLeft:"30px", width:"100%"}}>
            Your Profit
          </div>
          <img src={Menu} style={{height:"100%", cursor:"pointer"}} onClick={()=>this.props.Display(true)}></img>
